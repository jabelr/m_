...
function encrypt_decrypt($action, $string):string {
  ...
  $secret_key = 'AS00000000000000001111@@@@@#######111111111111111222222222221';
  $secret_iv = '[ELEANTEC]/3·AKEYMUYCHUNGA,YSIGOENAMORADODEMIELI,SIELMUNDOESJUSTO,ALGUNDIASEREFELIZ:________)#[ELEANTEC]';
